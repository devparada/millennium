...
if(MILLENNIUM_EMBED_ASSETS)
    ...
    set(HEADER_CONTENT "${HEADER_CONTENT}#else\n")
    if(DISTRO_NIX)
        set(HEADER_CONTENT "${HEADER_CONTENT}INCTXT(MILLENNIUM_CDP_ISOLATED_CTX_BIN_, \"${NIX_SHIMS}/cdp-isolated-ctx.js\");\n")
    else()
        set(HEADER_CONTENT "${HEADER_CONTENT}INCTXT(MILLENNIUM_CDP_ISOLATED_CTX_BIN_, \"${MILLENNIUM_BASE}/src/typescript/sdk/packages/cdp-isolated-ctx/build/cdp-isolated-ctx.js\");\n")
    endif()
    set(HEADER_CONTENT "${HEADER_CONTENT}#endif\n\n")
...
if(MILLENNIUM_EMBED_ASSETS OR DISTRO_NIX)
    ...
    set(HEADER_CONTENT "${HEADER_CONTENT}\t{ fmt::format(\"https://millennium.ftp/{}/cdp-isolated-ctx.js\", GetScrambledApiPathToken()), []() { return MILLENNIUM_CDP_ISOLATED_CTX_BIN_Data; } },\n")
else()
    ...
    set(HEADER_CONTENT "${HEADER_CONTENT}\t{ fmt::format(\"https://millennium.ftp/{}/millennium-frontend.js.map\", GetScrambledApiPathToken()), []() { return platform::read_file(MILLENNIUM_ROOT \"/src/typescript/.frontend.bin.map\"); } },\n")
    ...
    set(HEADER_CONTENT "${HEADER_CONTENT}\t{ fmt::format(\"https://millennium.ftp/{}/cdp-isolated-ctx.js\", GetScrambledApiPathToken()), []() { return platform::read_file(MILLENNIUM_ROOT \"/src/typescript/sdk/packages/cdp-isolated-ctx/build/cdp-isolated-ctx.js\"); } },\n")
endif()
